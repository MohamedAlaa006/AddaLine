            ...
            <div class="app-layout-drawer-scroll">
                ...
                <div id="logo" class="drawer-header">
                    <a href="<?php echo ADMINURL; ?>index.php">
                        <img class="img-responsive" src="../storage/logo/logo2.png" title="admin" alt="admin" /></a>
                </div>
                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-drawer-header">Manage Service/Gig</li>
                        <li class="nav-item">
                            <a href="<?php echo ADMINURL; ?>app/gig_category.php"><i class="ion-ios-list-outline"></i>Gig Category</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo ADMINURL; ?>app/gig_custom_field.php"><i class="ion-android-options"></i> Gig Custom Fields</a>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
                            <a href="#"><i class="ion-briefcase"></i> Gig Services</a>
                            <ul class="nav nav-subnav">
                                <li><a href="<?php echo ADMINURL; ?>app/gigs.php?status=active">Active</a></li>
                                <li><a href="<?php echo ADMINURL; ?>app/gigs.php?status=pending">Pending for approval</a></li>
                                <li><a href="<?php echo ADMINURL; ?>app/gigs.php">All Gigs List</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
                            <a href="#"><i class="ion-briefcase"></i> Orders</a>
                            <ul class="nav nav-subnav">
        ...
        if(!isset($config['purchase_key']) && $config['purchase_key'] == ""){
            ...
            <div class="app-layout-content">
                <div class="alert alert-warning" style="margin: 10px 10px 0 10px">
                    ...
                    <a class="text-info" style="cursor: pointer" href="<?php echo ADMINURL; ?>global/setting.php#quickad_purchase_code"><strong>Click here</strong></a>
                </div>
            </div>
            <?php
        }
