                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="quickad_settings_general">
                                                        <form method="post" action="<?php echo ADMINURL;?>ajax_sidepanel.php?action=SaveSettings" id="#quickad_settings_general">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <p class="help-block">Enter MIME types of files for resume separated by commas. <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types" target="_blank">Copy from this link</a>
                                                                    <br>e.g. <code>'application/pdf','application/msword', 'image/*'</code></p>
                                                                <div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="delete_expired">Delete listing after expire</label>
                                                                <p class="help-block">Expired listing will be deleted in 3 days if you select yes. Otherwise its stored for seo perpouse.</p>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="cookie_consent" class="form-control" id="cookie_consent">
                                                            ...
                                                            <div class="form-group hidden">
                                                                <label for="userthemesel">Allow User Theme Selection</label>
                                                        ...
                                                        <form method="post" action="<?php echo ADMINURL;?>ajax_sidepanel.php?action=SaveSettings" id="#quickad_home_page">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="home_page" id="home_page" class="form-control">
                                                                    ...
                                                                    <option value="home-gig" <?php if($config['home_page'] == 'home-gig'){ echo 'selected'; } ?>>Fiverr Home</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="show_search_home">Show/hide Search section on home page</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="show_categories_home">Show/hide Category section on home page</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="show_featured_jobs_home">Show/hide Featured Job section on home page</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="show_latest_jobs_home">Show/hide Latest Job section on home page</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="show_partner_logo_home" class="form-control">
                                                    ...
                                                    <div class="tab-pane" id="quickad_logo_watermark">
                                                        <form method="post" action="<?php echo ADMINURL;?>ajax_sidepanel.php?action=SaveSettings" id="#quickad_logo_watermark" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="screenshot"><img class="redux-option-image" id="image_logo_uploader" src="../assets/images/classic-theme_logo.png" alt="" target="_blank" rel="external"  style="border: 2px solid #eee;background-color: #000;max-width: 100%"></div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="screenshot"><img class="redux-option-image" id="image_flogo_uploader" src="../assets/images/classic-theme_logo.png" alt="" target="_blank" rel="external"  style="border: 2px solid #eee;background-color: #000;max-width: 100%"></div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="screenshot"><img class="redux-option-image" id="adminlogo" src="../assets/images/classic-theme_logo.png" alt="" target="_blank" rel="external"  style="border: 2px solid #eee;background-color: #000;max-width: 100%"></div>
                                                    ...
                                                    <div class="tab-pane" id="quickad_live_location">
                                                        <form method="post" action="<?php echo ADMINURL;?>ajax_sidepanel.php?action=SaveSettings" id="#quickad_live_location">
                                                            <div class="form-group">
                                                                ...
                                                                <p class="help-block"><i class="fa fa-crosshairs"></i>This icon Show on Home search where field and post listing location field.</p>
                                                                <div>
                                                    ...
                                                    <div class="tab-pane" id="quickad_purchase_code">
                                                        <form method="post" action="<?php echo ADMINURL;?>ajax_sidepanel.php?action=SaveSettings" id="#quickad_purchase_code">
                                                            <!--Default Horizontal Form-->
                                                            <div class="form-group">
                                                                <h4>Instructions</h4>
                                                                <p class="help-block">Verify the purchase code you will have access to free updates of Quicklancer. Updates may contain functionality improvements and important security fixes. <br>For more information on where to find your purchase code see this <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-can-I-find-my-Purchase-Code-" target="_blank">page</a>.</p>
                                                            </div>
                                                            <?php
                                                            ...
                                                            ?>
                                                            <div class="form-group">
                                                                <label>Quicklancer Purchase Code:</label>
                                                                <div>
